...
<?php echo "<div class='position-absolute mt-4 mb-5 '>
<div class=' mt-2 ml-4 mb-5 '>
<h4 id='test3'><b>$nom $prenom</b> </h4>
</div>";

echo "<div class=' mt-4 ml-4 mb-4 '>
<b>$email</b></div>
<div class=' mt-4 ml-4 mb-4 '>
<b>Classe : $classe </b></div>
<div class=' mt-4 ml-4 mb-5 '>
<b>Filière : $filiere </b></div>

<div  class=' ml-4'>
<input type='submit' name='modifier'  id='ch' class='btn text-white rounded'
value=' Information de récupération de mot de passe' ></div>
</div>
";?>
<div class=" mb-5 text-right mr-5 ">
<img class="rounded-circle mt-4 " style="width:30%;height:20%"  
src="../uploads/<?=$res['photoE']?>">
<div class="mt-2 mr-4" id='mr1'>
...
if (isset($_POST['modifier']) ){
    echo "<div id='test2'><div class='mt-5  mb-3 '>
    <table><td>
  <input type='text' class=\"form-control\" name='text'
  placeholder='Entrer un email'></td>
  <td><input  id='ch1' class='btn text-white rounded' name='up' type='submit' 
  value='Ajouter'></td></tr>
  </table></div></div>";  
}
...
if (isset($_POST['ok']) && isset($_FILES['image'])) {
    ...
    if ($error === 0) {
     ...
     if (in_array($extension_lc, $a_ex)) {
				...
				$sql = "UPDATE etudiant set photoE='$new_img_name'
                where 	id_etudiant=$id";
