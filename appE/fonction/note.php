...
<td><input type='submit' name='ok'  class="pt-2 pb-2 text-white rounded "
id='ok1' value='bulletin au format pdf '></td></tr>
        ...
        <div class="col-md-offset-1 col-md-18">
            <div class="panel">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col col-sm-4 col-xs-12 mt-1 mb-1">
                            <h4 class="title">Fichier Des Notes</h4>
                        </div>
                    </div>
                </div>
                <div class="panel-body table-responsive">
                    <table class="table">
                        ...
                        <tbody>
 <?php
 $_SESSION["id_etudiant_et"]=$id;
 $SQL31="SELECT * FROM note NATURAL JOIN matiere NATURAL JOIN etudiant
  WHERE id_etudiant='{$_SESSION["id_etudiant_et"]}' ORDER BY semestre DESC";
 $req31=mysqli_query($conn,$SQL31);
while($res31=mysqli_fetch_assoc($req31)){
$id_classe_note=$res31['id_classe'];
$id_matiere_note=$res31['id_matiere'];
$SQL31_1="SELECT MAX(valeur) AS Max_note, MIN(valeur) AS Min_note, AVG(valeur) AS Moy_note FROM note NATURAL JOIN etudiant WHERE id_classe='$id_classe_note' AND id_matiere='$id_matiere_note'";
$req31_1=mysqli_query($conn,$SQL31_1);
$res31_1=mysqli_fetch_assoc($req31_1);
echo "<tr><td></td>
<td>".$res31["nom_matiere"]."</td>
<td align='center'>".$res31["confession"]."</td>
<td align='center'>".$res31["valeur"]."</td>
<td align='center'>".$res31["semestre"]."</td>
<td align='center'>".$res31_1["Max_note"]."</td>
<td align='center'>".round($res31_1["Moy_note"],2)."</td>
<td align='center'>".$res31_1["Min_note"]."</td>
                            </tr>";
                            }
                            ?>
                        </tbody>
